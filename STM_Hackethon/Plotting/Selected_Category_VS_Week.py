...
log_file = open("Selected_Category_VS_Week log.txt","a+")
...
class Selected_Category_VS_Week():
    def __init__(self,selected_category):
        self.logger = App_Logger()
        self.selected_category = selected_category
    def Selected_Category_VS_Week_plot(self):
        ...
        self.logger.log(log_file, " Selected_Category_VS_Week plotting has started !!")
        plot=sc.groupby(['Week_Number'], as_index=False)[["passed", "failed"]].sum()
        ...
        ax.set_title('Status vs Work Week for Selected Category ')
        self.logger.log(log_file, "Great !! The beginning of the graph plotting has started")
        plt.show()
        self.logger.log(log_file, "Selected_Category_VS_Week plotting ended!!")
